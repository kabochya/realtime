...
Code.require_file("rls_diagnostics.exs", __DIR__)
...
defmodule RealtimeLatencyBenchmark do
  ...
  test "database to Realtime processing and delivery" do
    ...
    try do
      ...
      RlsDiagnostics.snapshot(admin, pending, output <> ".warmup.json")
      ...
      RlsDiagnostics.snapshot(admin, pending, output <> ".measured.json")
